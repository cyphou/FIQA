...
| ✅ **Tests** | 220 tests passed — engine, rules, scoring, preceptor, deployment, installer |
| 🐍 **Python** | 3.12+ · zero external dependencies |
| 📜 **License** | Internal — see repository settings |
| 🎯 **Coverage** | 64 rules · 5 object types · 6 Gold marts · 13-agent environment |
...
64 rules, ruleset version `2026.09.1`.
